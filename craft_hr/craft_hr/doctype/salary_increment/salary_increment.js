        ...
        if (!frm.is_new()) {
            frm.add_custom_button(__('Add Salary'), function() {
                ...
                frappe.call({
                    ...
                    callback: function(response) {
                        let latest_salary_structure = response.message.length > 0 ? response.message[0].salary_structure : null;
                        ...
                        let d = new frappe.ui.Dialog({
                            ...
                            fields: [
                                { fieldname: 'salary_increment', label: 'Salary Increment', fieldtype: 'Link', options: 'Salary Increment', default: frm.doc.name, read_only: 1 },
                                ...
                                { 
                                    ...
                                    reqd: 1, 
                                    default: latest_salary_structure 
                                },
