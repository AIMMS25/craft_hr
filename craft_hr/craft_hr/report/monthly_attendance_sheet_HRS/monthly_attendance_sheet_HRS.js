...
frappe.query_reports["Monthly Attendance Sheet HRS"] = {
	filters: [
		{
			fieldname: "month",
			label: __("Month"),
	...
	onload: function () {
		return frappe.call({
			method: "craft_hr.craft_hr.report.monthly_attendance_sheet_HRS.monthly_attendance_sheet_HRS.get_attendance_years",
			callback: function (r) {
