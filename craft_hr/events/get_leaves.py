...
def get_earned_leave(employee=None):
    ...
    for la in frappe.db.get_list('Leave Allocation', filters):
        ...
        new_used_leaves = len(frappe.db.get_list('Attendance',{'employee':doc.employee,'leave_type':doc.leave_type,'docstatus':1,'attendance_date':['between',[doc.from_date,doc.to_date]]}))
